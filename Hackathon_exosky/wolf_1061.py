...
background_image = pygame.image.load("sky_images/wolf1601_sky.jpeg")  # Replace with your image file path
...
exoplanet_name = "From Wolf 1061 c (Exoplanet)"


# Star data (x, y, size, name)
stars = [
    (-5.85, -10.95, 4, "Schedar ( alpha cas2)"),
    (-10.66, -12.00, 4, "Caph(cas 1)"),
    (1.02, -8.75, 4, "Gamma Cassiopeae(cas 3)"),
    (-9.76, -11.15, 4, "Ruchbah(cas 4)"),
    (-3.44, -7.36, 4, "Segin(cas 5)"),
    (4.74, 6.75, 4, "Dubhe(ursa 5)"),
    (4.36, 5.68, 4, "Merak(ursa 6)"),
    (3.84, 4.12, 4, "Phecda(ursa 7 then 4)"),
    (2.30, 5.50, 4, "Megrez(ursa 4)"),
    (5.12, 3.80, 4, "Fergus"),
    (3.80, 4.05, 4, "Alioth(ursa 3)"),
    (4.10, 4.32, 4, "Mizar(ursa 2)"),
    (6.58, 3.75, 4, "Alkaid(ursa 1)")
